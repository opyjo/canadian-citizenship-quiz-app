          ...
          <div className="lg:col-span-2 space-y-8">
            <Card>
              ...
              <CardContent className="space-y-4">
                <p>
                  The ancestors of Aboriginal peoples are believed to have
                  migrated from Asia many thousands of years ago. They were well
                  established here long before explorers from Europe first came
                  to North America.
                </p>
                <div className="bg-blue-50 p-4 rounded-lg">
                  ...
                  <ul className="space-y-2">
                    <li>
                      <strong>First Nations (Indian):</strong> About 65% of
                      Aboriginal people. About half live on reserve land in
                      about 600 communities.
                    </li>
                    <li>
                      <strong>Métis:</strong> 30% of Aboriginal people. A
                      distinct people of mixed Aboriginal and European ancestry,
                      majority live in Prairie provinces.
                    </li>
                    <li>
                      <strong>Inuit:</strong> 4% of Aboriginal people. "The
                      people" in Inuktitut language, live in small scattered
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <p>
                  ...
                  ago also reached Labrador and Newfoundland. The remains of
                  their settlement, l'Anse aux Meadows, are a World Heritage
                  site.
                </p>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="bg-green-50 p-4 rounded-lg">
                    ...
                    <p className="text-sm">
                      Italian immigrant to England, first to map Canada's
                      Atlantic shore, claiming Newfoundland for England.
                    </p>
                  </div>
                  <div className="bg-green-50 p-4 rounded-lg">
                    ...
                    <p className="text-sm">
                      Made three voyages, claiming land for France. Heard the
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <p>
                  ...
                  established by French explorers Pierre de Monts and Samuel de
                  Champlain. In 1608, Champlain built a fortress at what is now
                  Québec City.
                </p>
                <div className="bg-yellow-50 p-4 rounded-lg">
                  ...
                  <ul className="space-y-1 text-sm">
                    <li>
                      • French and Aboriginal people collaborated in the
                      fur-trade economy
                    </li>
                    <li>
                      • Outstanding leaders like Jean Talon, Bishop Laval, and
                      Count Frontenac
                    </li>
                    <li>
                    ...
                    <li>
                      • Voyageurs and coureurs des bois formed alliances with
                      First Nations
                    </li>
                  </ul>
                </div>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <p>
                  Believing it would be easy to conquer Canada, the United
                  States launched an invasion in June 1812. The Americans were
                  mistaken. Canadian volunteers and First Nations supported
                  British soldiers in Canada's defence.
                </p>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <p>
                  From 1864 to 1867, representatives of Nova Scotia, New
                  Brunswick and the Province of Canada worked together to
                ...
                <div className="bg-purple-50 p-4 rounded-lg">
                  ...
                  <p className="text-sm mb-2">
                    ...
                    in 1867. The Dominion of Canada was officially born on July
                    1, 1867.
                  </p>
                  <p className="text-sm">
                    <strong>Original Provinces:</strong> Ontario, Quebec, Nova
            ...
            <Card>
              ...
              <CardContent>
                <ul className="space-y-2 text-sm">
                  <li>
                    • Remember the three founding peoples: Aboriginal, French,
                    British
                  </li>
