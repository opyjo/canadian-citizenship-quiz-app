...
export default function GeographyPage() {
  const provinces = [
    { region: "Atlantic", name: "Newfoundland and Labrador", capital: "St. John's" },
    { region: "Atlantic", name: "Prince Edward Island", capital: "Charlottetown" },
    ...
    <div className="min-h-screen bg-gradient-to-br from-yellow-50 to-white">
      <div className="container mx-auto px-4 py-8">
        <div className="mb-6">
          ...
          <h1 className="text-4xl font-bold text-gray-900 mb-2">Canadian Geography</h1>
          <p className="text-xl text-gray-600">Canada's regions, provinces, and territories</p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div className="lg:col-span-2 space-y-8">
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <p>
                  Atlantic Canada's coasts and natural resources have made these provinces important to Canada's
                  history. Cool winters and cool humid summers.
                </p>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="bg-blue-50 p-4 rounded-lg">
                    <h4 className="font-semibold">Newfoundland and Labrador</h4>
                    <p className="text-sm">
                      Most easterly point, own time zone. Known for fisheries and offshore oil/gas. Labrador has
                  ...
                  <div className="bg-blue-50 p-4 rounded-lg">
                    ...
                    <p className="text-sm">
                      Smallest province. Known for beaches, red soil, potatoes. Birthplace of Confederation. Connected
                      by Confederation Bridge.
                    </p>
                  </div>
                  <div className="bg-blue-50 p-4 rounded-lg">
                    <h4 className="font-semibold">Nova Scotia</h4>
                    <p className="text-sm">
                      Most populous Atlantic province. Halifax is largest east coast port. World's highest tides in Bay
                      of Fundy.
                    </p>
                  </div>
                  <div className="bg-blue-50 p-4 rounded-lg">
                    ...
                    <p className="text-sm">
                      Only officially bilingual province. Founded by United Empire Loyalists. One-third population lives
                      and works in French.
                    </p>
                  </div>
                </div>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <p>
                  More than half of Canadians live in Central Canada - the industrial and manufacturing heartland.
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="bg-green-50 p-4 rounded-lg">
                    ...
                    <p className="text-sm mb-2">
                      Nearly 8 million people, mostly along St. Lawrence River. More than 3/4 speak French as first
                      language.
                    </p>
                    <ul className="text-xs space-y-1">
                      ...
                      <li>• Montreal is 2nd largest French-speaking city after Paris</li>
                    </ul>
                  </div>
                  <div className="bg-green-50 p-4 rounded-lg">
                    <h4 className="font-semibold">Ontario</h4>
                    <p className="text-sm mb-2">
                      More than 12 million people - over 1/3 of all Canadians. Toronto is largest city and main
                      financial centre.
                    </p>
                    <ul className="text-xs space-y-1">
                      <li>• Large percentage of Canada's exports</li>
                      <li>• Niagara region known for vineyards and wines</li>
                      <li>• Largest French-speaking population outside Quebec</li>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <p>
                  Manitoba, Saskatchewan, and Alberta are rich in energy resources and have some of the most fertile
                  farmland in the world. Mostly dry with cold winters and hot summers.
                </p>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div className="bg-yellow-50 p-4 rounded-lg">
                    <h4 className="font-semibold">Manitoba</h4>
                    <p className="text-sm">
                      Economy based on agriculture, mining, hydro-electric power. Winnipeg's Portage and Main is
                      Canada's most famous intersection. Largest Aboriginal population (15%+).
                    </p>
                  </div>
                  <div className="bg-yellow-50 p-4 rounded-lg">
                    <h4 className="font-semibold">Saskatchewan</h4>
                    <p className="text-sm">
                      "Breadbasket of the world" - 40% of Canada's arable land. World's richest uranium and potash
                      deposits. Regina is RCMP training academy home.
                    </p>
                  </div>
                  <div className="bg-yellow-50 p-4 rounded-lg">
                    <h4 className="font-semibold">Alberta</h4>
                    <p className="text-sm">
                      Most populous Prairie province. Largest oil and gas producer. Oil sands in north. Vast cattle
                      ranches. Five national parks including Banff (1885).
                    </p>
                  </div>
                </div>
              </CardContent>
              ...
              <CardContent className="space-y-4">
                <div className="bg-purple-50 p-4 rounded-lg">
                  ...
                  <ul className="text-sm space-y-1">
                    ...
                    <li>• Known for mining, fishing, Okanagan Valley fruit/wine</li>
                    <li>• Most extensive park system (600 provincial parks)</li>
                    <li>• Large Asian communities - Chinese and Punjabi widely spoken</li>
                    <li>• Victoria is capital and navy Pacific fleet headquarters</li>
                  </ul>
                </div>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <p>
                  One-third of Canada's land mass but only 100,000 people. "Land of the Midnight Sun" - 24 hours
                  daylight in summer, 3 months darkness in winter.
                </p>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div className="bg-gray-50 p-4 rounded-lg">
                    <h4 className="font-semibold">Yukon</h4>
                    <p className="text-sm">
                      Gold Rush of 1890s. Mining remains significant. White Pass and Yukon Railway. Coldest temperature
                      in Canada (-63°C). Capital: Whitehorse.
                    </p>
                  </div>
                  <div className="bg-gray-50 p-4 rounded-lg">
                    <h4 className="font-semibold">Northwest Territories</h4>
                    <p className="text-sm">
                      Yellowknife is "diamond capital of North America." More than half population is Aboriginal.
                      Mackenzie River is 2nd longest in North America.
                    </p>
                  </div>
                  <div className="bg-gray-50 p-4 rounded-lg">
                    <h4 className="font-semibold">Nunavut</h4>
                    <p className="text-sm">
                      "Our land" in Inuktitut. Established 1999. 85% Inuit population. Inuktitut is official language.
          ...
          <div className="space-y-6">
                ...
                <div className="space-y-2 text-sm">
                  {provinces.map((province, index) => (
                    ...
                    >
                      ...
                      <div className="text-xs text-gray-600">{province.capital}</div>
                    </div>
                  ))}
                </div>
              </CardContent>
            ...
            <div className="flex space-x-2">
              ...
              <Link href="/study/economy" className="flex-1">
                <Button className="w-full bg-purple-600 hover:bg-purple-700">Next: Economy</Button>
              </Link>
            </div>
          </div>
        </div>
