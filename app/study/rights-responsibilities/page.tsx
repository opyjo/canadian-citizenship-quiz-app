    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-white">
      <div className="container mx-auto px-4 py-8">
        <div className="mb-6">
          ...
          <h1 className="text-4xl font-bold text-gray-900 mb-2">Rights and Responsibilities</h1>
          <p className="text-xl text-gray-600">Understanding Canadian citizenship</p>
        </div>
          ...
          <div className="lg:col-span-2 space-y-8">
            <Card>
              ...
              <CardContent className="space-y-4">
                <p>
                  Canadian law has several sources, including laws passed by Parliament and provincial legislatures,
                  English common law, the civil code of France, and the unwritten constitution inherited from Great
                  Britain.
                </p>
                <div className="bg-blue-50 p-4 rounded-lg">
                  ...
                  <ul className="space-y-1">
                    ...
                    <li>• Freedom of thought, belief, opinion and expression</li>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="bg-green-50 p-4 rounded-lg">
                    <h4 className="font-semibold">Aboriginal Peoples' Rights</h4>
                    <p className="text-sm">
                  ...
                  <div className="bg-green-50 p-4 rounded-lg">
                    ...
                    <p className="text-sm">A fundamental characteristic of Canadian heritage and identity.</p>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <p>
                  ...
                  barbaric cultural practices that tolerate:
                </p>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div className="bg-orange-50 p-4 rounded-lg">
                    ...
                    <p className="text-sm">
                      First Nations, Inuit, and Métis - the original inhabitants with diverse cultures rooted in
                      spiritual beliefs.
                    </p>
                  </div>
                  <div className="bg-orange-50 p-4 rounded-lg">
                  ...
                  <div className="bg-orange-50 p-4 rounded-lg">
                    ...
                    <p className="text-sm">
                      18 million Anglophones. English, Welsh, Scottish, and Irish settlers established the basic way of
                      life.
                    </p>
                  </div>
                </div>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <p>
                  Canada is often referred to as a land of immigrants. Over the past 200 years, millions of newcomers
                  have helped build and defend our way of life.
                </p>
                <div className="bg-purple-50 p-4 rounded-lg">
                  <h4 className="font-semibold mb-2">Largest Groups:</h4>
                  <p className="text-sm">
                    English, French, Scottish, Irish, German, Italian, Chinese, Aboriginal, Ukrainian, Dutch, South
                ...
                <div className="bg-purple-50 p-4 rounded-lg">
                  ...
                  <p className="text-sm">
                    Majority identify as Christians (Catholic largest, followed by Protestant churches). Growing numbers
                    of Muslims, Jews, Hindus, Sikhs, and others.
                  </p>
                </div>
                <div className="bg-purple-50 p-4 rounded-lg">
                  <h4 className="font-semibold mb-2">LGBTQ+ Rights:</h4>
                  <p className="text-sm">
                    Gay and lesbian Canadians enjoy full protection and equal treatment under the law, including access
                    to civil marriage.
                  </p>
                </div>
              </CardContent>
          ...
          <div className="space-y-6">
              ...
              <CardContent>
                <div className="space-y-3 text-sm">
                  ...
                  <div className="border-l-4 border-green-500 pl-3">
                    <strong>Habeas Corpus</strong> - Right to challenge unlawful detention
                  </div>
                  <div className="border-l-4 border-yellow-500 pl-3">
                    <strong>Due Process</strong> - Government must respect legal rights
                  </div>
                  <div className="border-l-4 border-purple-500 pl-3">
                    <strong>Presumption of Innocence</strong> - Innocent until proven guilty
                  </div>
                  <div className="border-l-4 border-red-500 pl-3">
                    <strong>Multiculturalism</strong> - Celebrating diversity in unity
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                <ul className="space-y-2 text-sm">
                  ...
                  <li>• Understand Charter rights (mobility, language, etc.)</li>
            ...
            <div className="flex space-x-2">
              ...
              <Link href="/study/government-structure" className="flex-1">
                <Button className="w-full bg-green-600 hover:bg-green-700">Next: Government</Button>
              </Link>
            </div>
          </div>
        </div>
