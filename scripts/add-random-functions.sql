...
-- Function to get only incorrect questions for a specific user
...
GRANT EXECUTE ON FUNCTION get_incorrect_questions(UUID) TO authenticated;
...
-- SELECT * FROM get_incorrect_questions('your-user-id-here'); 